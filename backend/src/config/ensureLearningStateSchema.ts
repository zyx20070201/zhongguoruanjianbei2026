...
const statements = [
  ...
  `CREATE TABLE IF NOT EXISTS "LearnerProfileCandidate" (
    "id" TEXT NOT NULL PRIMARY KEY,
    "workspaceId" TEXT NOT NULL,
    "workbenchId" TEXT,
    ...
    "payloadJson" TEXT NOT NULL DEFAULT '{}',
    "sourcePipeline" TEXT NOT NULL DEFAULT 'learner_portrait_pipeline',
    "observedAt" DATETIME,
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "LearnerProfileCandidate_workspaceId_fkey" FOREIGN KEY ("workspaceId") REFERENCES "Workspace" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "LearnerProfileCandidate_workbenchId_fkey" FOREIGN KEY ("workbenchId") REFERENCES "Workbench" ("id") ON DELETE SET NULL ON UPDATE CASCADE
  )`,
  `CREATE UNIQUE INDEX IF NOT EXISTS "LearnerProfileCandidate_workspaceId_candidateKey_key" ON "LearnerProfileCandidate"("workspaceId", "candidateKey")`,
  `CREATE INDEX IF NOT EXISTS "LearnerProfileCandidate_workspaceId_dimension_status_idx" ON "LearnerProfileCandidate"("workspaceId", "dimension", "status")`,
  `CREATE INDEX IF NOT EXISTS "LearnerProfileCandidate_workspaceId_updatedAt_idx" ON "LearnerProfileCandidate"("workspaceId", "updatedAt")`,
  `CREATE TABLE IF NOT EXISTS "LearnerProfileEntity" (
    "id" TEXT NOT NULL PRIMARY KEY,
    "workspaceId" TEXT NOT NULL,
    "workbenchId" TEXT,
    ...
    "evidenceIdsJson" TEXT NOT NULL DEFAULT '[]',
    "candidateKeysJson" TEXT NOT NULL DEFAULT '[]',
    "affectedConceptsJson" TEXT NOT NULL DEFAULT '[]',
    "recommendation" TEXT NOT NULL DEFAULT '',
    "payloadJson" TEXT NOT NULL DEFAULT '{}',
    "resolutionSource" TEXT NOT NULL DEFAULT 'builder',
    "polishSource" TEXT NOT NULL DEFAULT 'fallback',
    "entityHash" TEXT NOT NULL DEFAULT '',
    "observedAt" DATETIME,
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "LearnerProfileEntity_workspaceId_fkey" FOREIGN KEY ("workspaceId") REFERENCES "Workspace" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "LearnerProfileEntity_workbenchId_fkey" FOREIGN KEY ("workbenchId") REFERENCES "Workbench" ("id") ON DELETE SET NULL ON UPDATE CASCADE
  )`,
  `CREATE UNIQUE INDEX IF NOT EXISTS "LearnerProfileEntity_workspaceId_entityKey_key" ON "LearnerProfileEntity"("workspaceId", "entityKey")`,
  `CREATE INDEX IF NOT EXISTS "LearnerProfileEntity_workspaceId_dimension_status_idx" ON "LearnerProfileEntity"("workspaceId", "dimension", "status")`,
  `CREATE INDEX IF NOT EXISTS "LearnerProfileEntity_workspaceId_updatedAt_idx" ON "LearnerProfileEntity"("workspaceId", "updatedAt")`
];

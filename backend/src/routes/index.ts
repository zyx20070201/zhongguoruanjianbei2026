...
import workbenchTableRoutes from './workbenchTable';
...
import audioNoteRoutes from './audioNotes';
...
router.use('/workbench-table', workbenchTableRoutes);
...
router.use('/audio-notes', audioNoteRoutes);

import { focusTextModel, getInlineEditorByModel, markdownInput, textKeymap, } from '@blocksuite/affine-components/rich-text';
    ...
    return {
        ...
        Enter: ctx => {
            ...
            if (model.type.startsWith('h') && model.collapsed) {
                ...
                const newId = doc.addBlock(model.flavour, { type: model.type, text: rightText }, parent, index + collapsedSiblings.length + 1);

...
export declare enum IdGeneratorType {
    /**
...
export declare function pickIdGenerator(idGenerator: IdGeneratorType | IdGenerator | undefined, clientId: number): IdGenerator;

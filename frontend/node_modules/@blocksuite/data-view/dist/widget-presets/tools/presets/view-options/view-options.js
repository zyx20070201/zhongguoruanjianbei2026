...
const createSettingMenus = (target, dataViewInstance, reopen) => {
        ...
        settingItems.push(menu.action({
          ...
          ${ArrowRightSmallIcon()}`,
            select: () => {
                ...
                const sortUtils = createSortUtils(sortTrait, dataViewInstance.eventTrace);
                if (!sortList.length) {
...
export const popViewOptions = (target, dataViewInstance, onClose) => {
    const view = dataViewInstance.view;
    const reopen = () => {
        ...
        items: [
            ...
            ${ArrowRightSmallIcon()}`,
                select: () => {
                  ...
                  `,
                                select: () => {
                                    view.manager.viewChangeType(view.manager.currentViewId$.value, meta.type);

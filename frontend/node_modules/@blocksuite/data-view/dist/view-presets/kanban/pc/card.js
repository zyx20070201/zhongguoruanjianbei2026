        ...
        constructor() {
            ...
            this.clickMore = (e) => {
                ...
                if (selection) {
                    ...
                    popCardMenu(this.dataViewEle, popupTargetFromElement(ele), this.cardId, selection);
                }
            };
            this.contextMenu = (e) => {
                e.stopPropagation();
                ...
                if (selection) {
                    ...
                    popCardMenu(this.dataViewEle, popupTargetFromElement(ref), this.cardId, selection);
                }
            };

...
export class TableHotkeysController {
    ...
    hostConnected() {
        this.host.disposables.add(this.host.props.bindHotkey({
            Backspace: () => {
            ...
            'Mod-a': context => {
                ...
                if (selection) {
                    ...
                    this.selectionController.selection = TableRowSelection.create({
                        rows: this.host.props.view.groupTrait.groupsDataList$.value?.flatMap(group => group.rows.map(id => ({ groupKey: group.key, id }))) ??
            ...
            '/': context => {
                ...
                if (cell) {
                    ...
                    popRowMenu(this.host.props.dataViewEle, popupTargetFromElement(cell), this.selectionController);
                }
            },
        }));
    }

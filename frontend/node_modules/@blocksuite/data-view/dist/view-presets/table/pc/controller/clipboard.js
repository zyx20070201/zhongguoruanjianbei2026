...
export class TableClipboardController {
    ...
    hostConnected() {
        this.host.disposables.add(this.props.handleEvent('copy', _ctx => {
            const tableSelection = this.host.selectionController.selection;
            if (!tableSelection)
                return false;
            this._onCopy(tableSelection);
        ...
        this.host.disposables.add(this.props.handleEvent('cut', _ctx => {
            const tableSelection = this.host.selectionController.selection;
            if (!tableSelection)
                return false;
            this._onCut(tableSelection);
        ...
        this.host.disposables.add(this.props.handleEvent('paste', ctx => {
            if (this.readonly)
                return false;

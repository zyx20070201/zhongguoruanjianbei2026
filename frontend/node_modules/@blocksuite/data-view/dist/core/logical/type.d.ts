...
export type Unify = (ctx: TypeVarContext, type: TypeInstance | undefined, expect: TypeInstance | undefined) => boolean;
export type TypeConvertConfig<From extends TypeInstance = TypeInstance, To extends TypeInstance = TypeInstance> = {
    from: From;
    to: To;

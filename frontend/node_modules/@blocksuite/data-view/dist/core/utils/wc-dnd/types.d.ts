...
export type Activator = (container: HTMLElement, startSession: (id: UniqueIdentifier, activeNode: HTMLElement, sessionCreator: DndSessionCreator) => void) => Unsubscription;

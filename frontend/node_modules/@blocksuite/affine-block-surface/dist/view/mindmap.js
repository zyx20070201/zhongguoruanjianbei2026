...
export class MindMapView extends GfxElementModelView {
    ...
    _initCollapseButtons() {
        ...
        this.disposable.add(this.model.propsUpdated.on(({ key }) => {
            if (key === 'layoutType' || key === 'style') {
                updateButtons();
            }
        }));
        this.disposable.add(this.surface.elementUpdated.on(payload => {
    ...
    _setVisibleOnSelection() {
        let lastNode = null;
        this.disposable.add(this.gfx.selection.slots.updated.on(() => {

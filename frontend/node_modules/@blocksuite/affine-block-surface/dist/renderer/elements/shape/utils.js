...
import { getFontString, getLineHeight, getLineWidth, getTextWidth, measureTextInDOM, wrapText, wrapTextDeltas, } from '../text/utils.js';
export function drawGeneralShape(ctx, shapeModel, renderer, filled, fillColor, strokeColor) {
    ...
    if (shapeModel.shadow) {
        ...
        const enableShadowBlur = shapeModel.surface.doc.awarenessStore.getFlag('enable_shape_shadow_blur');

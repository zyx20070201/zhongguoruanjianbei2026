...
export type ElementModelMatcher<TNode extends object = never> = {
    ...
    toAST: (element: Record<string, unknown>, context: ElementModelAdapterContext<TNode>) => TNode | null;
};
export declare abstract class ElementModelAdapter<AST = unknown, TNode extends object = never> {
    /**
     * Convert element model to AST format
     */
    abstract fromElementModel(element: Record<string, unknown>, context: ElementModelAdapterContext<TNode>): AST | null;
}

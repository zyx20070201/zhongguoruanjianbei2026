import { ConnectionOverlay, EdgelessSurfaceBlockSpec, } from '@blocksuite/affine-block-surface';
...
import { EdgelessFrameManager, FrameOverlay, } from '../../root-block/edgeless/frame-manager.js';
...
export const EdgelessToolExtension = [
    DefaultTool,
    PanTool,
    EraserTool,
    TextTool,
...
export const EdgelessBuiltInManager = [
    ConnectionOverlay,
    FrameOverlay,

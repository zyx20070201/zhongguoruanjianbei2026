...
export function attachmentViewToggleMenu({ block, callback, }) {
    ...
    >
      <div data-size="small" data-orientation="vertical">
        ${repeat(viewActions, button => button.type, ({ type, label, action, disabled }) => html `
            <editor-menu-action
...
export function AttachmentOptionsTemplate({ block, model, abortController, }) {
    const std = block.std;

...
export class LegacyDragEventWatcher {
    constructor(widget) {
        ...
        this._startDragging = (blocks, state, dragPreviewEl, dragPreviewOffset) => {
            ...
            this.widget.dragPreview = this.widget.previewHelper.createDragPreview(blocks, 
            // @ts-ignore
            state, dragPreviewEl, dragPreviewOffset);
...
//# sourceMappingURL=legacy-drag-event-watcher.js.map
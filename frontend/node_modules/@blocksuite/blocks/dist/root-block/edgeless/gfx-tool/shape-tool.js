...
import { DEFAULT_SHAPE_FILL_COLOR, DEFAULT_SHAPE_STROKE_COLOR, getShapeType, } from '@blocksuite/affine-model';
...
export class ShapeTool extends BaseTool {
    ...
    _resize(shiftPressed = false, spacePressed = false) {
        ...
        if (spacePressed && this._spacePressedCtx) {
            const { startX, startY, w, h, endX: pressedX, endY: pressedY, } = this._spacePressedCtx.draggingArea;
    ...
    clearOverlay() {
        ...
        this.gfx.surfaceComponent?.renderer.removeOverlay(this._shapeOverlay);
        this._shapeOverlay = null;
        this.gfx.surfaceComponent?.renderer.refresh();
    }
    click(e) {
        this.clearOverlay();
    ...
    createOverlay() {
        ...
        this.gfx.surfaceComponent?.renderer.addOverlay(this._shapeOverlay);
    }
    deactivate() {
        this.clearOverlay();
    }

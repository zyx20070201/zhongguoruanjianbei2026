import { LayoutType, MindmapElementModel, } from '@blocksuite/affine-model';
...
import { getNearestTranslation, isElementOutsideViewport, isSingleMindMapNode, } from '../../_common/edgeless/mindmap/index.js';
...
export class EdgelessPageKeyboardManager extends PageKeyboardManager {
    constructor(rootComponent) {
        ...
        this.rootComponent.bindHotKey({
            ...
            'Shift-l': () => {
                ...
                this._setEdgelessTool('lasso', {
                    mode: cur?.toolName === 'lasso'
                        ? cur.activatedOption.mode === LassoMode.FreeHand
                            ? LassoMode.Polygonal
                            : LassoMode.FreeHand
                        : LassoMode.FreeHand,
                });
    ...
    _setEdgelessTool(toolName, ...options) {
        ...
        this.rootComponent.gfx.tool.setTool(toolName, 
        // @ts-ignore

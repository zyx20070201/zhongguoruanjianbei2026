import { Et as y, Ft as assertExists, Mt as DisposableGroup, St as g, f as DocCollection, xt as Slot } from "./dist-CDz72cpx.js";
import { AS as when, Bf as ThemeProvider, D_ as classMap, ES as repeat, El as guard, FS as state, GS as requiredProperties, HS as unsafeCSS, IS as property, J as EdgelessEditorBlockSpecs, LS as LitElement, PS as query, RS as html, Sg as NoteDisplayMode, TS as ShadowlessElement, Uf as i, VS as css, Vo as scrollbarStyle, WS as PropTypes, XS as SignalWatcher, YS as WithDisposable, cS as BlockStdScope, od as keyed, rC as clamp, z as PageEditorBlockSpecs, zS as nothing } from "./surface-ref-block-edgeless-BeCGUFZr.js";
import { t as BlocksUtils } from "./dist-BufGqEPY.js";
//#region node_modules/@blocksuite/presets/dist/editors/edgeless-editor.js
...
var EdgelessEditor = (() => {
	...
	return class EdgelessEditor extends _classSuper {
		static {
			...
			__esDecorate$8(this, null, _doc_decorators, {
				kind: "accessor",
				name: "doc",
				static: false,
				private: false,
				...
				metadata: _metadata
			}, _doc_initializers, _doc_extraInitializers);
			__esDecorate$8(this, null, _editor_decorators, {
				kind: "accessor",
				name: "editor",
				static: false,
				private: false,
				access: {
					has: (obj) => "editor" in obj,
					get: (obj) => obj.editor,
					set: (obj, value) => {
						obj.editor = value;
					}
				...
				metadata: _metadata
			}, _editor_initializers, _editor_extraInitializers);
			__esDecorate$8(this, null, _specs_decorators, {
				kind: "accessor",
				name: "specs",
				static: false,
				private: false,
				access: {
					has: (obj) => "specs" in obj,
					get: (obj) => obj.specs,
					set: (obj, value) => {
						obj.specs = value;
					}
				...
				metadata: _metadata
			}, _specs_initializers, _specs_extraInitializers);
			__esDecorate$8(this, null, _std_decorators, {
				kind: "accessor",
				name: "std",
				static: false,
				private: false,
				...
				metadata: _metadata
			}, _std_initializers, _std_extraInitializers);
  ...
  `;
		...
		render() {
			...
			const std = this.std;
			return html`
      <div class="affine-edgeless-viewport" data-theme=${std.get(ThemeProvider).edgeless$.value}>
    ...
    `;
		...
		willUpdate(changedProperties) {
			...
			if (changedProperties.has("doc")) this.std = new BlockStdScope({
				doc: this.doc,
				extensions: this.specs
			});
		}
		#doc_accessor_storage = __runInitializers$8(this, _doc_initializers, void 0);
		get doc() {
			return this.#doc_accessor_storage;
		}
		set doc(value) {
			this.#doc_accessor_storage = value;
		}
		#editor_accessor_storage = (__runInitializers$8(this, _doc_extraInitializers), __runInitializers$8(this, _editor_initializers, void 0));
		get editor() {
			return this.#editor_accessor_storage;
		}
		set editor(value) {
			this.#editor_accessor_storage = value;
		}
		#specs_accessor_storage = (__runInitializers$8(this, _editor_extraInitializers), __runInitializers$8(this, _specs_initializers, EdgelessEditorBlockSpecs));
		get specs() {
			return this.#specs_accessor_storage;
		}
		set specs(value) {
			this.#specs_accessor_storage = value;
		}
		#std_accessor_storage = (__runInitializers$8(this, _specs_extraInitializers), __runInitializers$8(this, _std_initializers, void 0));
		get std() {
		...
		constructor() {
			super(...arguments);
			__runInitializers$8(this, _std_extraInitializers);
		}
	};
})();
//#endregion
//#region node_modules/@blocksuite/presets/dist/editors/editor-container.js
...
var AffineEditorContainer = (() => {
	...
	return class AffineEditorContainer extends _classSuper {
		static {
			const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
			_autofocus_decorators = [property({ attribute: false })];
			__esDecorate$7(this, null, _autofocus_decorators, {
				kind: "accessor",
				name: "autofocus",
				static: false,
				private: false,
  ...
  `;
		...
		*/
		...
		firstUpdated() {
			if (this.mode === "page") setTimeout(() => {
				if (this.autofocus) (this.querySelector("rich-text")?.inlineEditor)?.focusEnd();
			});
		}
		render() {
      ...
      `)}`;
		...
		*/
		updated(changedProperties) {
			if (changedProperties.has("doc")) this.slots.docUpdated.emit({ newDocId: this.doc.id });
			if (!changedProperties.has("doc") && !changedProperties.has("mode")) return;
		}
		...
		constructor() {
			super(...arguments);
			this._doc = y();
			this._edgelessSpecs = y(EdgelessEditorBlockSpecs);
			this._mode = y("page");
			this._pageSpecs = y(PageEditorBlockSpecs);
			this._specs = g(() => this._mode.value === "page" ? this._pageSpecs.value : this._edgelessSpecs.value);
			this._std = g(() => {
			...
			this._editorTemplate = g(() => {
				return this._std.value.render();
			});
			/**
			* @deprecated need to refactor
			*/
			this.slots = { docUpdated: new Slot() };
			this.#autofocus_accessor_storage = __runInitializers$7(this, _autofocus_initializers, false);
			__runInitializers$7(this, _autofocus_extraInitializers);
		}
	};
})();
//#endregion
//#region node_modules/@blocksuite/presets/dist/editors/page-editor.js
...
var PageEditor = (() => {
	...
	return class PageEditor extends _classSuper {
		static {
			...
			_specs_decorators = [property({ attribute: false })];
			_std_decorators = [state()];
			__esDecorate$6(this, null, _doc_decorators, {
				kind: "accessor",
				name: "doc",
				static: false,
				private: false,
			...
			__esDecorate$6(this, null, _hasViewport_decorators, {
				kind: "accessor",
				name: "hasViewport",
				static: false,
				private: false,
				access: {
					has: (obj) => "hasViewport" in obj,
					get: (obj) => obj.hasViewport,
					set: (obj, value) => {
						obj.hasViewport = value;
					}
				},
				metadata: _metadata
			}, _hasViewport_initializers, _hasViewport_extraInitializers);
			__esDecorate$6(this, null, _specs_decorators, {
				kind: "accessor",
				name: "specs",
				static: false,
				private: false,
			...
			__esDecorate$6(this, null, _std_decorators, {
				kind: "accessor",
				name: "std",
				static: false,
				private: false,
  ...
  `;
		...
		render() {
			...
			return html`
      <div
        data-theme=${std.get(ThemeProvider).app$.value}
    ...
    `;
		...
		#doc_accessor_storage = __runInitializers$6(this, _doc_initializers, void 0);
		get doc() {
			return this.#doc_accessor_storage;
		}
		set doc(value) {
		...
		#hasViewport_accessor_storage = (__runInitializers$6(this, _doc_extraInitializers), __runInitializers$6(this, _hasViewport_initializers, true));
		get hasViewport() {
			return this.#hasViewport_accessor_storage;
		}
		set hasViewport(value) {
			this.#hasViewport_accessor_storage = value;
		}
		#specs_accessor_storage = (__runInitializers$6(this, _hasViewport_extraInitializers), __runInitializers$6(this, _specs_initializers, PageEditorBlockSpecs));
		get specs() {
			return this.#specs_accessor_storage;
		}
		set specs(value) {
		...
		#std_accessor_storage = (__runInitializers$6(this, _specs_extraInitializers), __runInitializers$6(this, _std_initializers, void 0));
		get std() {
			return this.#std_accessor_storage;
		}
		set std(value) {
		...
		constructor() {
			super(...arguments);
			__runInitializers$6(this, _std_extraInitializers);
		}
	};
})();
//#endregion
//#region node_modules/@blocksuite/presets/dist/fragments/comment/comment-manager.js
var CommentManager = class {
	...
	addComment(selection, payload) {
		...
		if (!parseResult) throw new Error("Invalid selection");
	...
	parseTextSelection(selection) {
		...
		return {
			quote: blocks.reduce((acc, block, index) => {
				const text = block.model.text;
				if (!text) return acc;
				if (index === 0) return acc + text.yText.toString().slice(from.index, from.index + from.length);
				if (index === blocks.length - 1 && to) return acc + " " + text.yText.toString().slice(0, to.index + to.length);
...
//#endregion
//#region node_modules/@blocksuite/presets/dist/fragments/comment/comment-input.js
...
var CommentInput = (() => {
	...
	return class CommentInput extends _classSuper {
		static {
			const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
			...
			__esDecorate$5(this, null, __editor_decorators, {
				kind: "accessor",
				name: "_editor",
				static: false,
				private: false,
				access: {
					has: (obj) => "_editor" in obj,
					get: (obj) => obj._editor,
					set: (obj, value) => {
						obj._editor = value;
					}
				...
				metadata: _metadata
			}, __editor_initializers, __editor_extraInitializers);
			__esDecorate$5(this, null, _manager_decorators, {
				kind: "accessor",
				name: "manager",
				static: false,
				private: false,
				access: {
					has: (obj) => "manager" in obj,
					get: (obj) => obj.manager,
					set: (obj, value) => {
						obj.manager = value;
					}
				...
				metadata: _metadata
			}, _manager_initializers, _manager_extraInitializers);
			__esDecorate$5(this, null, _onSubmit_decorators, {
				kind: "accessor",
				name: "onSubmit",
				static: false,
				private: false,
				access: {
					has: (obj) => "onSubmit" in obj,
					get: (obj) => obj.onSubmit,
					set: (obj, value) => {
						obj.onSubmit = value;
					}
				},
				metadata: _metadata
			}, _onSubmit_initializers, _onSubmit_extraInitializers);
			if (_metadata) Object.defineProperty(this, Symbol.metadata, {
				enumerable: true,
				configurable: true,
				writable: true,
  ...
  `;
      ...
      <rich-text
        ...
        .yText=${new DocCollection.Y.Doc().getText("comment")}
      ...
      <div class="comment-control">
		...
		get _editor() {
			return this.#_editor_accessor_storage;
		}
		set _editor(value) {
			this.#_editor_accessor_storage = value;
		}
		#manager_accessor_storage;
		get manager() {
			return this.#manager_accessor_storage;
		}
		set manager(value) {
			this.#manager_accessor_storage = value;
		}
		#onSubmit_accessor_storage;
		get onSubmit() {
			return this.#onSubmit_accessor_storage;
		}
		set onSubmit(value) {
			this.#onSubmit_accessor_storage = value;
		}
		constructor() {
			super(...arguments);
			this._cancel = () => {
			...
			this.#_editor_accessor_storage = __runInitializers$5(this, __editor_initializers, void 0);
			this.#manager_accessor_storage = (__runInitializers$5(this, __editor_extraInitializers), __runInitializers$5(this, _manager_initializers, void 0));
			this.#onSubmit_accessor_storage = (__runInitializers$5(this, _manager_extraInitializers), __runInitializers$5(this, _onSubmit_initializers, void 0));
			__runInitializers$5(this, _onSubmit_extraInitializers);
		}
	};
})();
//#endregion
//#region node_modules/@blocksuite/presets/dist/fragments/comment/comment-panel.js
...
var CommentPanel = (() => {
	...
	let _editor_initializers = [];
	let _editor_extraInitializers = [];
	return class CommentPanel extends _classSuper {
		static {
			const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
			__container_decorators = [query(".comment-panel-container")];
			_editor_decorators = [property({ attribute: false })];
			__esDecorate$4(this, null, __container_decorators, {
				kind: "accessor",
				name: "_container",
				static: false,
				private: false,
				access: {
					has: (obj) => "_container" in obj,
					get: (obj) => obj._container,
					set: (obj, value) => {
						obj._container = value;
					}
				},
				metadata: _metadata
			}, __container_initializers, __container_extraInitializers);
			__esDecorate$4(this, null, _editor_decorators, {
				kind: "accessor",
				name: "editor",
				static: false,
				private: false,
  ...
  `;
		...
		_addComment() {
			if (!this.editor.host?.selection.find("text")) return;
      ...
      <div class="comment-panel-comments">
		...
		get _container() {
			return this.#_container_accessor_storage;
		}
		set _container(value) {
			this.#_container_accessor_storage = value;
		}
		...
		constructor() {
			...
			this.#_container_accessor_storage = __runInitializers$4(this, __container_initializers, void 0);
			this.#editor_accessor_storage = (__runInitializers$4(this, __container_extraInitializers), __runInitializers$4(this, _editor_initializers, void 0));
			__runInitializers$4(this, _editor_extraInitializers);
		}
	};
})();
//#endregion
//#region node_modules/@blocksuite/presets/dist/fragments/doc-title/doc-title.js
...
var DocTitle = (() => {
	...
	return class DocTitle extends _classSuper {
		static {
			...
			_doc_decorators = [property({ attribute: false })];
			__esDecorate$3(this, null, __isComposing_decorators, {
				kind: "accessor",
				name: "_isComposing",
				static: false,
				private: false,
				access: {
					has: (obj) => "_isComposing" in obj,
					get: (obj) => obj._isComposing,
					set: (obj, value) => {
						obj._isComposing = value;
					}
				},
				metadata: _metadata
			}, __isComposing_initializers, __isComposing_extraInitializers);
			__esDecorate$3(this, null, __isReadonly_decorators, {
				kind: "accessor",
				name: "_isReadonly",
				static: false,
				private: false,
				access: {
					has: (obj) => "_isReadonly" in obj,
					get: (obj) => obj._isReadonly,
					set: (obj, value) => {
						obj._isReadonly = value;
					}
				},
				metadata: _metadata
			}, __isReadonly_initializers, __isReadonly_extraInitializers);
			__esDecorate$3(this, null, __richTextElement_decorators, {
				kind: "accessor",
				name: "_richTextElement",
				static: false,
				private: false,
				access: {
					has: (obj) => "_richTextElement" in obj,
					get: (obj) => obj._richTextElement,
					set: (obj, value) => {
						obj._richTextElement = value;
					}
				},
				metadata: _metadata
			}, __richTextElement_initializers, __richTextElement_extraInitializers);
			__esDecorate$3(this, null, _doc_decorators, {
				kind: "accessor",
				name: "doc",
				static: false,
				private: false,
  ...
  `;
		...
		render() {
			return html`
      <div
        class="doc-title-container ${!this._rootModel.title.length && !this._isComposing ? "doc-title-container-empty" : ""}"
    ...
    `;
		...
		get _isComposing() {
			return this.#_isComposing_accessor_storage;
		}
		set _isComposing(value) {
			this.#_isComposing_accessor_storage = value;
		}
		#_isReadonly_accessor_storage;
		get _isReadonly() {
			return this.#_isReadonly_accessor_storage;
		}
		set _isReadonly(value) {
			this.#_isReadonly_accessor_storage = value;
		}
		#_richTextElement_accessor_storage;
		get _richTextElement() {
			return this.#_richTextElement_accessor_storage;
		}
		set _richTextElement(value) {
			this.#_richTextElement_accessor_storage = value;
		}
		...
		constructor() {
			...
			this._updateTitleInMeta = () => {
				this.doc.collection.setDocMeta(this.doc.id, { title: this._rootModel.title.toString() });
			};
			this.#_isComposing_accessor_storage = __runInitializers$3(this, __isComposing_initializers, false);
			this.#_isReadonly_accessor_storage = (__runInitializers$3(this, __isComposing_extraInitializers), __runInitializers$3(this, __isReadonly_initializers, false));
			this.#_richTextElement_accessor_storage = (__runInitializers$3(this, __isReadonly_extraInitializers), __runInitializers$3(this, __richTextElement_initializers, void 0));
			this.#doc_accessor_storage = (__runInitializers$3(this, __richTextElement_extraInitializers), __runInitializers$3(this, _doc_initializers, void 0));
			__runInitializers$3(this, _doc_extraInitializers);
		}
	};
})();
...
//#endregion
//#region node_modules/@blocksuite/presets/dist/fragments/frame-panel/frame-panel.js
...
var FramePanel = (() => {
	...
	return class FramePanel extends _classSuper {
		static {
			...
			__esDecorate$2(this, null, _fitPadding_decorators, {
				kind: "accessor",
				name: "fitPadding",
				static: false,
				private: false,
				access: {
					has: (obj) => "fitPadding" in obj,
					get: (obj) => obj.fitPadding,
					set: (obj, value) => {
						obj.fitPadding = value;
					}
				},
				metadata: _metadata
			}, _fitPadding_initializers, _fitPadding_extraInitializers);
			__esDecorate$2(this, null, _host_decorators, {
				kind: "accessor",
				name: "host",
				static: false,
				private: false,
				...
				metadata: _metadata
			}, _host_initializers, _host_extraInitializers);
			if (_metadata) Object.defineProperty(this, Symbol.metadata, {
				enumerable: true,
				configurable: true,
				writable: true,
      ...
      ></affine-frame-panel-body>
		...
		#fitPadding_accessor_storage = __runInitializers$2(this, _fitPadding_initializers, [
			50,
			380,
			50,
			50
		...
		get fitPadding() {
			return this.#fitPadding_accessor_storage;
		}
		set fitPadding(value) {
			this.#fitPadding_accessor_storage = value;
		}
		#host_accessor_storage = (__runInitializers$2(this, _fitPadding_extraInitializers), __runInitializers$2(this, _host_initializers, void 0));
		get host() {
		...
		constructor() {
			super(...arguments);
			__runInitializers$2(this, _host_extraInitializers);
		}
	};
})();
//#endregion
//#region node_modules/@blocksuite/presets/dist/fragments/_common/icons.js
...
//#endregion
//#region node_modules/@blocksuite/presets/dist/fragments/outline/outline-panel.js
...
var OutlinePanel = (() => {
	...
	return class OutlinePanel extends _classSuper {
		static {
			...
			_editor_decorators = [property({ attribute: false })];
			_fitPadding_decorators = [property({ attribute: false })];
			__esDecorate$1(this, null, __enableNotesSorting_decorators, {
				kind: "accessor",
				name: "_enableNotesSorting",
				static: false,
				private: false,
				access: {
					has: (obj) => "_enableNotesSorting" in obj,
					get: (obj) => obj._enableNotesSorting,
					set: (obj, value) => {
						obj._enableNotesSorting = value;
					}
				},
				metadata: _metadata
			}, __enableNotesSorting_initializers, __enableNotesSorting_extraInitializers);
			__esDecorate$1(this, null, __noticeVisible_decorators, {
				kind: "accessor",
				name: "_noticeVisible",
				static: false,
				private: false,
				access: {
					has: (obj) => "_noticeVisible" in obj,
					get: (obj) => obj._noticeVisible,
					set: (obj, value) => {
						obj._noticeVisible = value;
					}
				},
				metadata: _metadata
			}, __noticeVisible_initializers, __noticeVisible_extraInitializers);
			__esDecorate$1(this, null, __showPreviewIcon_decorators, {
				kind: "accessor",
				name: "_showPreviewIcon",
				static: false,
				private: false,
				access: {
					has: (obj) => "_showPreviewIcon" in obj,
					get: (obj) => obj._showPreviewIcon,
					set: (obj, value) => {
						obj._showPreviewIcon = value;
					}
				},
				metadata: _metadata
			}, __showPreviewIcon_initializers, __showPreviewIcon_extraInitializers);
			__esDecorate$1(this, null, _editor_decorators, {
				kind: "accessor",
				name: "editor",
				static: false,
				private: false,
			...
			__esDecorate$1(this, null, _fitPadding_decorators, {
				kind: "accessor",
				name: "fitPadding",
				static: false,
				private: false,
    ...
    `;
		...
		get _enableNotesSorting() {
			return this.#_enableNotesSorting_accessor_storage;
		}
		set _enableNotesSorting(value) {
			this.#_enableNotesSorting_accessor_storage = value;
		}
		#_noticeVisible_accessor_storage;
		get _noticeVisible() {
			return this.#_noticeVisible_accessor_storage;
		}
		set _noticeVisible(value) {
			this.#_noticeVisible_accessor_storage = value;
		}
		#_showPreviewIcon_accessor_storage;
		get _showPreviewIcon() {
			return this.#_showPreviewIcon_accessor_storage;
		}
		set _showPreviewIcon(value) {
			this.#_showPreviewIcon_accessor_storage = value;
		}
		#editor_accessor_storage;
		get editor() {
			return this.#editor_accessor_storage;
		...
		constructor() {
			...
			this.#_enableNotesSorting_accessor_storage = __runInitializers$1(this, __enableNotesSorting_initializers, false);
			this.#_noticeVisible_accessor_storage = (__runInitializers$1(this, __enableNotesSorting_extraInitializers), __runInitializers$1(this, __noticeVisible_initializers, false));
			this.#_showPreviewIcon_accessor_storage = (__runInitializers$1(this, __noticeVisible_extraInitializers), __runInitializers$1(this, __showPreviewIcon_initializers, false));
			this.#editor_accessor_storage = (__runInitializers$1(this, __showPreviewIcon_extraInitializers), __runInitializers$1(this, _editor_initializers, void 0));
			this.#fitPadding_accessor_storage = (__runInitializers$1(this, _editor_extraInitializers), __runInitializers$1(this, _fitPadding_initializers, void 0));
			__runInitializers$1(this, _fitPadding_extraInitializers);
		}
	};
})();
//#endregion
//#region node_modules/@blocksuite/presets/dist/fragments/outline/utils/query.js
function getNotesFromDoc(doc, modes) {
	...
	rootModel.children.forEach((block, index) => {
		...
		if (modes.includes(blockModel.displayMode)) notes.push(OutlineNoteItem);
	});
	return notes;
}
...
function getHeadingBlocksFromNote(note, ignoreEmpty = false) {
	return note.children.filter((block) => {
...
function getHeadingBlocksFromDoc(doc, modes, ignoreEmpty = false) {
	return getNotesFromDoc(doc, modes).map(({ note }) => getHeadingBlocksFromNote(note, ignoreEmpty)).flat();
}
//#endregion
//#region node_modules/@blocksuite/presets/dist/fragments/outline/utils/scroll.js
...
function isBlockBeforeViewportCenter(blockId, editorHost) {
	...
	return blockRect.top + blockRect.height / 2 < editorCenter + blockRect.height;
}
var observeActiveHeadingDuringScroll = (getEditor, update) => {
	update(getEditor().doc.root?.id ?? null);
	...
	disposables.addFromEvent(window, "scroll", () => {
		...
		headings.forEach((heading) => {
			if (isBlockBeforeViewportCenter(heading.id, host)) activeHeadingId = heading.id;
		});
...
function highlightBlock(editor, blockId) {
	...
	if (highlightTimeoutId !== null) clearTimeout(highlightTimeoutId);
	highlightTimeoutId = setTimeout(() => {
		if (highlightMask) highlightMask.style.display = "none";
	}, 1e3);
	return () => {
...
async function scrollToBlockWithHighlight(editor, blockId, timeout = 3e3) {
	...
	return new Promise((resolve) => {
		if (highlightIntervalId !== null) clearInterval(highlightIntervalId);
		let lastTop = -1;
...
//#endregion
//#region node_modules/@blocksuite/presets/dist/fragments/outline/outline-viewer.js
...
var OutlineViewer = (() => {
	let _classDecorators = [requiredProperties({ editor: PropTypes.object })];
	...
	var OutlineViewer = class extends _classSuper {
		...
		static {
			...
			__esDecorate(this, null, __activeItem_decorators, {
				kind: "accessor",
				name: "_activeItem",
				static: false,
				private: false,
				access: {
					has: (obj) => "_activeItem" in obj,
					get: (obj) => obj._activeItem,
					set: (obj, value) => {
						obj._activeItem = value;
					}
				},
				metadata: _metadata
			}, __activeItem_initializers, __activeItem_extraInitializers);
			__esDecorate(this, null, __showViewer_decorators, {
				kind: "accessor",
				name: "_showViewer",
				static: false,
				private: false,
				access: {
					has: (obj) => "_showViewer" in obj,
					get: (obj) => obj._showViewer,
					set: (obj, value) => {
						obj._showViewer = value;
					}
				},
				metadata: _metadata
			}, __showViewer_initializers, __showViewer_extraInitializers);
			__esDecorate(this, null, _editor_decorators, {
				kind: "accessor",
				name: "editor",
				static: false,
				private: false,
			...
			__esDecorate(this, null, _toggleOutlinePanel_decorators, {
				kind: "accessor",
				name: "toggleOutlinePanel",
				static: false,
				private: false,
				access: {
					has: (obj) => "toggleOutlinePanel" in obj,
					get: (obj) => obj.toggleOutlinePanel,
					set: (obj, value) => {
						obj.toggleOutlinePanel = value;
					}
				},
				metadata: _metadata
			}, _toggleOutlinePanel_initializers, _toggleOutlinePanel_extraInitializers);
  ...
  `;
		...
		render() {
			if (this.editor.doc.root === null || this.editor.mode === "edgeless") return nothing;
			...
			const items = [...this.editor.doc.meta?.title !== "" ? [this.editor.doc.root] : [], ...headingBlocks];
          ...
          ${repeat(items, (block) => block.id, (block) => {
              ...
              >
                <affine-outline-block-preview
                  class=${classMap({ active: this._activeHeadingId$.value === block.id })}
                  .block=${block}
                  @click=${() => {
    ...
    `;
		...
		get _activeItem() {
			return this.#_activeItem_accessor_storage;
		}
		set _activeItem(value) {
			this.#_activeItem_accessor_storage = value;
		}
		#_showViewer_accessor_storage;
		get _showViewer() {
			return this.#_showViewer_accessor_storage;
		}
		set _showViewer(value) {
			this.#_showViewer_accessor_storage = value;
		}
		#editor_accessor_storage;
		get editor() {
			return this.#editor_accessor_storage;
		...
		get toggleOutlinePanel() {
			return this.#toggleOutlinePanel_accessor_storage;
		}
		set toggleOutlinePanel(value) {
			this.#toggleOutlinePanel_accessor_storage = value;
		}
		constructor() {
			super(...arguments);
			this._activeHeadingId$ = y(null);
			this._highlightMaskDisposable = () => {};
			this._lockActiveHeadingId = false;
			this._scrollPanel = () => {
...
//#endregion
export { getDocTitleByEditorHost as C, PageEditor as D, CommentManager as E, AffineEditorContainer as O, DocTitle as S, CommentInput as T, SmallFrameNavigatorIcon as _, getHeadingBlocksFromDoc as a, AFFINE_FRAME_PANEL as b, isRootBlock as c, placeholderMap as d, previewIconMap as f, SmallCloseIcon as g, SmallArrowDownIcon as h, scrollToBlockWithHighlight as i, EdgelessEditor as k, AFFINE_OUTLINE_PANEL as l, SettingsIcon as m, OutlineViewer as n, getNotesFromDoc as o, HiddenIcon as p, observeActiveHeadingDuringScroll as r, isHeadingBlock as s, AFFINE_OUTLINE_VIEWER as t, OutlinePanel as u, SmallLinkedDocIcon as v, CommentPanel as w, FramePanel as x, SortingIcon as y };

//# sourceMappingURL=outline-viewer-BI8q7sNR.js.map